/*
  makewidescopeheaders.mjs
  Use a specified table-definition file to create a wide complex table
  with scope and headers attributes. Write an HTML document containing
  the table to a specified file.
  Arguments:
...
headerSpecs.forEach(rowSpecs => {
  ...
  rowSpecs.forEach(cellSpecs => {
    ...
    if (cellSpecs[2] > 1) {
      ...
      insertAtts(doc, cell, {
        colspan: src.schema.categories.length,
        scope: 'colgroup'
      });
    }
    else {
